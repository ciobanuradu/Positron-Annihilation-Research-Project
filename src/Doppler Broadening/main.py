...
plt.plot(x, AM241[:, 1], "r")
plt.plot(x, BA133[:, 1], "g")
plt.plot(x, CO60[:, 1], "b")
plt.plot(x, NA22[:, 1], "y")
plt.show()
...
#plotting the FWHM
plt.plot(AM_FWHM[0], AM_FWHM[1], "ro")
plt.plot(BA_FWHM_1[0], BA_FWHM_1[1], "go")
plt.plot(BA_FWHM_2[0], BA_FWHM_2[1], "go")
plt.plot(BA_FWHM_3[0], BA_FWHM_3[1], "go")
plt.plot(BA_FWHM_4[0], BA_FWHM_4[1], "go")
plt.plot(BA_FWHM_5[0], BA_FWHM_5[1], "go")
plt.plot(CO_FWHM_1[0], CO_FWHM_1[1], "bo")
plt.plot(CO_FWHM_2[0], CO_FWHM_2[1], "bo")
plt.plot(NA_FWHM_1[0], NA_FWHM_1[1], "yo")
plt.plot(NA_FWHM_2[0], NA_FWHM_2[1], "yo")
plt.show()
...
plt.plot(NA_FWHM_1[0], NA_FWHM_1[1], "yo")
plt.plot(peak_positions, peak_heights, "ro")
plt.plot(x, error(x, *popt), "-r")
plt.show()
